                    ...
                    <ul class="products-cart">
                        @foreach(Cart::content() as $item)
                            ...
                            <li class="pr-cart-item">
                                ...
                                <div class="price-field sub-total"><p class="price">{{ number_format($item->subtotal, 0, '.', '.') }}</p></div>
                                <div class="delete">

                                    <a href="#" class="btn btn-delete" wire:model.prevent="remove({{$item->rowId}})" title="">
                ...
                <div class="wrap-products">
                    <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5"
                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="#" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                    <figure><img src="assets/images/products/digital_1.jpg" width="214" height="214"
                                                 alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                </a>
                                <div class="group-flash">
