                        ...
                        <ul>
                            <li class="menu-item">
                                <a title="Hotline: (+123) 456 789" href="#"><span
                                        class="icon label-before fa fa-mobile"></span>Hotline: 0962.370.557</a>
                            </li>
                        </ul>
                    </div>
                                    ...
                                    @if(Auth::user()->type === 'admin')
                                        <li class="menu-item menu-item-has-children parent">
                                            ...
                                            <ul class="submenu curency">
                                                <li class="menu-item">
                                                    <a title="" href="{{ route('dashboard') }}">Dashboard</a>
                                                </li>
                                                <li class="menu-item">
                ...
                <div class="primary-nav-section">
                    <div class="container">
                        <ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu">
                            ...
                            <li class="menu-item">
                                <a href="/shop" class="link-term mercado-item-title">Sản phẩm</a>
                            </li>
                            <li class="menu-item">
                ...
                <ul>
                    <li class="fc-info-item">
                        ...
                        <div class="wrap-left-info">
                            ...
                            <p class="fc-desc">Miễn phí từ đơn hàng 500.000đ</p>
                        </div>
                    ...
                    <li class="fc-info-item">
                        ...
                        <div class="wrap-left-info">
                            ...
                            <p class="fc-desc">Bảo hành 1 năm</p>
                        </div>
                    ...
                    <li class="fc-info-item">
                        ...
                        <div class="wrap-left-info">
                            ...
                            <p class="fc-desc">Thanh toán online an toàn</p>
                        </div>
                                ...
                                <div class="wrap-contact-detail">
                                    <ul>
                                        <li>
                                            ...
                                            <p class="contact-txt">01 Trịnh Văn Bô - Nam Từ Liêm - Hà Nội</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-phone" aria-hidden="true"></i>
                                            <p class="contact-txt">0962.370.557</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-envelope" aria-hidden="true"></i>
                                            <p class="contact-txt">hieunucek6@gmail.com</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="wrap-footer-item">
                            ...
                            <div class="item-content">
                                <div class="wrap-hotline-footer">
                                    <span class="desc">Gọi free</span>
                                    <b class="phone-number">0962.370.557</b>
                                </div>
                            </div>
                        </div>

                        <div class="wrap-footer-item footer-item-second">
                            <h3 class="item-header">Đăng ký nhận tin</h3>
                            <div class="item-content">
